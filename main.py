...
def obter_credenciais_supabase():
    ...
    # Remove espaços e barras do final da URL informada
    url_base = st.secrets["SUPABASE_URL"].strip().rstrip("/")
    
    # Se o usuário já colou a URL com '/rest/v1', limpa para não duplicar
    ...
    # Retorna a URL base limpa pronta para receber o sufixo correto
...
if menu == "📋 Cadastro & Edição de Máquinas":
    ...
    with aba_lista:
        ...
        # Rota de segurança blindada contra caminhos inválidos
