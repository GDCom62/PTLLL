...
def atualizar_dados(tabela: str, payload: dict, coluna_id: str, valor_id):
    ...
    # Formato padrão da API Postgrest do Supabase para filtros na URL
...
if st.session_state.editando_maquina_id is not None:
    ...
    if mq_editar:
        ...
        if btn_salvar_mq:
            ...
            if sucesso:
                ...
                st.error("Falha ao salvar no banco de dados. Verifique a tabela ou permissões.")
    ...
    if botao_salvar and id_eq and nome_eq:
        ...
        if sucesso:
            ...
            st.error("Erro ao inserir dados no Supabase.")
