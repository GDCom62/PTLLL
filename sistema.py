...
# --- FUNÇÃO PARA CONVERTER IMAGEM LOCAL EM BASE64 ---import streamlit as st
import json
import os
import base64
...
# ==========================================
# 2. PLANEJAMENTO TEMPORAL (RESOLVIDO)
# ==========================================
    ...
    def exibir_itens(frequencia, chave_check):
        ...
        if dados:
            for p in dados:
                st.write(f"⚙️ **{p['equipamento']}** | 📅 **Data Prevista:** {p.get('data_prevista', 'Não definida')} | **Status:** {p['status']}")
